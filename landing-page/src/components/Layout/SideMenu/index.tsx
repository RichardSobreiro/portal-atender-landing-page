...
const menuItems = [
  ...
  },
  {
    ...
    icon: faUserInjured,
    subItems: [
      { label: 'Anamneses', link: '/pacientes/anamneses' },
      { label: 'Modelos de Anamneses', link: '/pacientes/anamneses/modelos' },
    ],
  },
  {
    label: 'Calendário',
  ...
  },
  {
    ...
    link: '/atendimentos',
    icon: faStethoscope,
    subItems: [{ label: 'Procedimentos', link: '/atendimentos/procedimentos' }],
  },
